    ...
    describe("createExpense", () => {
      it("should create a new expense request with all required fields", async () => {
        const mockExpenseData = {
          ...
          departmentId: mockDepartmentId,
          categoryId: mockCategoryId,
          expenseTypeId: "type-expense-123",
        ...
        const mockCreatedExpense = {
          ...
          expense_type_id: mockExpenseData.expenseTypeId,
          expense_type_name: "Regular Expense",
          expense_type_code: "expense",
        ...
        expect(apiClient.post).toHaveBeenCalledWith("/expenses/", {
          ...
          expenseTypeId: mockExpenseData.expenseTypeId,
          title: mockExpenseData.title,
          amount: mockExpenseData.amount,
          currency: mockExpenseData.currency,
      ...
      it("should create per_diem expense type", async () => {
        const mockPerDiemData = {
          ...
          departmentId: mockDepartmentId,
          categoryId: mockCategoryId,
          expenseTypeId: "type-per-diem-123",
        ...
        const mockCreatedExpense = {
          ...
          expense_type_id: mockPerDiemData.expenseTypeId,
          expense_type_name: "Per Diem",
          expense_type_code: "per_diem",
        ...
        expect(result.expense_type_code).toBe("per_diem");
      });
    });
    ...
    describe("getExpense", () => {
      it("should fetch a single expense by ID", async () => {
        const mockExpense = {
          ...
          expense_type_id: "type-expense-123",
          expense_type_name: "Regular Expense",
          expense_type_code: "expense",
          title: "Taxi fare",
          amount: 25.5,
