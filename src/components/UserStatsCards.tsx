  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white rounded-lg shadow-medium p-6 animate-pulse">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-heading font-bold text-primary">{totalUsers}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-heading font-bold text-status-success">{activeUsers}</p>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-text-secondary mb-1">Inactive Users</p>
              <p className="text-3xl font-heading font-bold text-text-disabled">{inactiveUsers}</p>
              <p className="text-xs text-text-secondary mt-1">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-text-secondary mb-1">Recent Signups</p>
      ...
      <div className="bg-white rounded-lg shadow-medium p-6">
        <h3 className="text-lg font-heading font-bold text-text-primary mb-4">Users by Role</h3>
      ...
      {stats.recent_signups && stats.recent_signups.length > 0 && (
        <div className="bg-white rounded-lg shadow-medium p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-heading font-bold text-text-primary">Recent Signups</h3>
            <Link
              href="/dashboard/users"
