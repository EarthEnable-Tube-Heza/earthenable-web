      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-large p-8 md:p-12">
          ...
          <div className="flex justify-center gap-4 mb-8">
            <div
              className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center animate-bounce"
            ...
            <div
              className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center animate-bounce"
            ...
            <div
              className="w-16 h-16 bg-accent/10 rounded-full flex items-center justify-center animate-bounce"
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              Oops! This page is still being built. Just like our earthen homes, great things take
              time and careful craftsmanship.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-text-secondary leading-relaxed">
                  ...
                  eco-friendly, sustainable construction. We provide dignified, affordable earthen
                  floors to rural families who need them most, replacing dirt floors with smooth,
                  durable surfaces that improve health, reduce maintenance, and create pride in
                  homeownership.
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-border-light text-center">
            <p className="text-sm text-text-secondary italic">
              &quot;Just as we transform dirt floors into dignified homes, we&apos;re building this
              dashboard to transform field operations. Every line of code, like every earthen floor,
              is laid with care and purpose.&quot;
            </p>
          </div>
        </div>
