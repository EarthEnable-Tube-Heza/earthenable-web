...
/**
 * Task Subjects Page (under Tasks tab)
 *
    ...
    <div className="space-y-6">
      ...
      <div className="bg-status-info/10 border border-status-info rounded-lg p-4">
        <div className="flex items-start gap-3">
          <span className="text-status-info text-xl">i</span>
          <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Button onClick={() => setIsCreateSubjectModalOpen(true)}>+ New Task Subject</Button>
          <Button variant="secondary" onClick={() => setIsCreateMappingModalOpen(true)}>
            + New Form Mapping
          </Button>
        </div>
      </div>
              ...
              <table className="w-full min-w-[900px]">
                ...
                <tbody className="divide-y divide-border-light">
                  {mappings.map((mapping) => (
                    <tr key={mapping.id} className="hover:bg-background-light transition-colors">
