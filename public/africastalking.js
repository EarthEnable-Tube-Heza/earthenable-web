!(function (e, t) {
  ...
  return (function (e) {
      ...
      e.exports = {
        ...
        detectBrowser: function (e) {
          ...
          if (t.mozGetUserMedia)
            ((r.browser = "firefox"), (r.version = a(t.userAgent, /Firefox\/(\d+)\./, 1)));
          else if (t.webkitGetUserMedia)
            ((r.browser = "chrome"), (r.version = a(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)));
          else if (t.mediaDevices && t.userAgent.match(/Edge\/(\d+).(\d+)$/))
            ((r.browser = "edge"), (r.version = a(t.userAgent, /Edge\/(\d+).(\d+)$/, 2)));
          else {
    ...
    function (e, t, r) {
      var n = (function (e) {
        ...
        function S(e, t) {
          ...
          if ("throw" === n.type)
            return ((t.method = "throw"), (t.arg = n.arg), (t.delegate = null), d);
          var i = n.arg;
          return i
            ? i.done
        ...
        switch (c.browser) {
          case "chrome":
            if (!d || !d.shimPeerConnection || !a.shimChrome)
              return (s("Chrome shim is not included in this adapter release."), m);
          ...
          case "firefox":
            if (!l || !l.shimPeerConnection || !a.shimFirefox)
              return (s("Firefox shim is not included in this adapter release."), m);
          ...
          case "edge":
            if (!u || !u.shimPeerConnection || !a.shimEdge)
              return (s("MS edge shim is not included in this adapter release."), m);
          ...
          case "safari":
            if (!p || !a.shimSafari)
              return (s("Safari shim is not included in this adapter release."), m);
                ...
                if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
                  ...
                  return (
                    ...
                    t.getReceivers().forEach(function (e) {
                      return (e.track === a && (n ? (i = !0) : (n = e)), e.track === a);
                    }),
                    i || (r && n)
                      ? Promise.reject(
                          new DOMException(
          ...
          if (e.RTCPeerConnection) {
            ...
            ((e.RTCPeerConnection.prototype.removeStream = function (e) {
              ...
              (e.RTCPeerConnection.prototype.addTrack = function (t, r) {
                ...
                if (o)
                  ...
                  ((n._streams[r.id] = s), (n._reverseStreams[s.id] = r), n.addStream(s));
                }
            ...
            e.RTCPeerConnection.prototype.setLocalDescription = function () {
              ...
              return arguments.length && arguments[0].type
                ? ((arguments[0] = d(e, arguments[0])), o.apply(e, arguments))
                : o.apply(e, arguments);
            };
              ...
              if (
                ...
                if (
                  ...
                  "environment" === s.exact || "environment" === s.ideal
                    ? (c = ["back", "rear"])
                    : ("user" !== s.exact && "user" !== s.ideal) || (c = ["front"]),
                  c)
                )
                  return r.mediaDevices.enumerateDevices().then(function (t) {
                    ...
                    return (
                      !r && t.length && -1 !== c.indexOf("back") && (r = t[t.length - 1]),
                      r &&
    ...
    function (e, t, r) {
      ...
      function i(e, t, r, i, a) {
        ...
        if (
          ...
          ((o += "a=" + c),
            ...
            e.sendEncodingParameters[0].rtx &&
              ((o += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + c),
              (o +=
                "a=ssrc-group:FID " +
                e.sendEncodingParameters[0].ssrc +
                " " +
        ...
        return (
          ...
          e.rtpSender &&
            e.sendEncodingParameters[0].rtx &&
            (o +=
              "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " cname:" + n.localCName + "\r\n"),
          o
        );
      }
      function a(e, t) {
      ...
      e.exports = function (e, t) {
        ...
        (Object.defineProperty(u.prototype, "localDescription", {
                  ...
                  if (!(i.usingBundle && r > 0)) {
                    ...
                    ((u[o.candidate.sdpMLineIndex] += c
                      ...
                      (i._localDescription.sdp =
                        n.getDescription(i._localDescription.sdp) + u.join("")));
          ...
          (u.prototype._transceive = function (e, r, i) {
            ...
            (r &&
              ...
              (o.rtcp = { cname: n.localCName, compound: e.rtcpParameters.compound }),
              ...
              t.forEach(function (e, t) {
                ...
                if (
                  ...
                  (s && (m.role = "server"),
                    (i.usingBundle && 0 !== t) ||
                      (i._gather(o.mid, t),
                      "new" === d.state && d.start(c, f, s ? "controlling" : "controlled"),
          ...
          (u.prototype.setRemoteDescription = function (i) {
            ...
            if (!o("setRemoteDescription", i.type, u.signalingState) || u._isClosed)
              return Promise.reject(
                c(
                  "InvalidStateError",
                  "Can not set remote " + i.type + " in state " + u.signalingState
                )
              );
            var l = {};
            ...
            return (
              (u.canTrickleIceCandidates = !!g && g.substr(14).split(" ").indexOf("trickle") >= 0),
              f.forEach(function (o, c) {
                var d = n.splitLines(o),
                  f = n.getKind(o),
                  g = n.isRejected(o) && 0 === n.matchPrefix(o, "a=bundle-only").length,
                  y = d[0].substr(2).split(" ")[2],
                  S = n.getDirection(o, m),
                  C = n.parseMsid(o),
                  T = n.getMid(o) || n.generateIdentifier();
                if (g || ("application" === f && ("DTLS/SCTP" === y || "UDP/DTLS/SCTP" === y)))
                  u.transceivers[c] = { mid: T, kind: f, protocol: y, rejected: !0 };
                else {
                  ...
                  var L = n.parseRtcpParameters(o),
                    A = n.matchPrefix(o, "a=end-of-candidates", m).length > 0,
                    j = n
                  ...
                  if (
                    ...
                    if ("answer" === i.type && !g) {
                      ((k = (b = u.transceivers[c]).iceGatherer),
                        (w = b.iceTransport),
                        (R = b.dtlsTransport),
                        (P = b.rtpReceiver),
                        ...
                        (u.transceivers[c].remoteCapabilities = I),
                        (u.transceivers[c].rtcpParameters = L),
                        j.length &&
                          "new" === w.state &&
                          ((!v && !A) || (h && 0 !== c)
                        ...
                        (h && 0 !== c) ||
                          ("new" === w.state && w.start(k, M, "controlling"),
                          "new" === R.state && R.start(O)),
                        !a(b.localCapabilities, b.remoteCapabilities).codecs.filter(function (e) {
                        ...
                        !P || ("sendrecv" !== S && "sendonly" !== S)
                          ? delete b.rtpReceiver
                          : ((_ = P.track),
                            C
                              ? (l[C.stream] || (l[C.stream] = new e.MediaStream()),
                                r(_, l[C.stream]),
                                p.push([_, P, l[C.stream]]))
                              : (l.default || (l.default = new e.MediaStream()),
                                r(_, l.default),
                                p.push([_, P, l.default]))));
                    }
                  } else {
                    (((b = u.transceivers[c] || u._createTransceiver(f)).mid = T),
                      b.iceGatherer || (b.iceGatherer = u._createIceGatherer(c, h)),
                      j.length &&
                        ...
                        (!A || (h && 0 !== c)
                          ...
                          : b.iceTransport.setRemoteCandidates(j)),
                      (x = e.RTCRtpReceiver.getCapabilities(f)),
                      t < 15019 &&
                        (x.codecs = x.codecs.filter(function (e) {
                          return "rtx" !== e.name;
                        })),
                      (E = b.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]));
                    var N,
                      G = !1;
                    if ("sendrecv" === S || "sendonly" === S) {
                      if (
                        ((G = !b.rtpReceiver),
                        (P = b.rtpReceiver || new e.RTCRtpReceiver(b.dtlsTransport, f)),
                        G)
                      )
                        ((_ = P.track),
                          (C && "-" === C.stream) ||
                            (C
                              ? (l[C.stream] ||
                                  ((l[C.stream] = new e.MediaStream()),
                                  Object.defineProperty(l[C.stream], "id", {
                                    get: function () {
                                      return C.stream;
                                    },
                                  })),
                                ...
                                (N = l[C.stream]))
                              : (l.default || (l.default = new e.MediaStream()), (N = l.default))),
                          N && (r(_, N), b.associatedRemoteMediaStreams.push(N)),
                          p.push([_, P, N]));
                    } else
                      b.rtpReceiver &&
                        b.rtpReceiver.track &&
                    ...
                    ((b.localCapabilities = x),
                      ...
                      u._transceive(u.transceivers[c], !1, G));
                  }
                }
              }),
                  ...
                  return (
                    "application" === e.kind
                      ...
                      : "audio" === e.kind
                        ...
                        : "video" === e.kind &&
                          (o += "m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"),
            ...
            return e && void 0 === e.sdpMLineIndex && !e.sdpMid
              ...
              : new Promise(function (i, a) {
                  ...
                  if (e && "" !== e.candidate) {
                    ...
                    if (
                      (0 === o || (o > 0 && u.iceTransport !== r.transceivers[0].iceTransport)) &&
                      !s(u.iceTransport, l)
                    )
                      return a(c("OperationError", "Can not add ICE candidate"));
                    var p = e.candidate.trim();
                    (0 === p.indexOf("a=") && (p = p.substr(2)),
                      ((t = n.getMediaSections(r._remoteDescription.sdp))[o] +=
                        "a=" + (l.type ? p : "end-of-candidates") + "\r\n"),
                    ...
                    for (
                      ...
                      (r.transceivers[f].rejected ||
                        ...
                        ((t = n.getMediaSections(r._remoteDescription.sdp))[f] +=
                          "a=end-of-candidates\r\n"),
                        (r._remoteDescription.sdp =
                          n.getDescription(r._remoteDescription.sdp) + t.join("")),
                        !r.usingBundle));
        ...
        return (
          ...
          (l = ["setLocalDescription", "setRemoteDescription", "addIceCandidate"]).forEach(
            function (e) {
              var t = u.prototype[e];
              u.prototype[e] = function () {
                var e = arguments;
            ...
            ((r.mediaDevices.getUserMedia = function (e) {
              return (
                "object" == typeof e &&
                  ...
                  ((e = JSON.parse(JSON.stringify(e))),
                  u(e.audio, "autoGainControl", "mozAutoGainControl"),
                  u(e.audio, "noiseSuppression", "mozNoiseSuppression")),
                l(e)
              );
            }),
            ...
            a.prototype.applyConstraints = function (e) {
              return (
                "audio" === this.kind &&
                  "object" == typeof e &&
                  ((e = JSON.parse(JSON.stringify(e))),
                  u(e, "autoGainControl", "mozAutoGainControl"),
                  u(e, "noiseSuppression", "mozNoiseSuppression")),
                f.apply(this, [e])
              );
            };
          }
    ...
    function (e, t, r) {
      ...
      var d = { trace: n, debug: i, vdebug: a, log: o, warn: s, error: c },
        u = r(0),
        l = r.n(u);
      function p(e) {
        return (p =
      ...
      var f = null,
        ...
        C = function (e) {
          switch (e.response) {
            ...
            case "closed":
              ...
              break;
            case "offline":
              (d.debug("Connection is offline, token expired"), d.debug(e), m("offline"));
              break;
            case "trickle":
              ...
              (d.debug("Got a trickled candidate"),
                ...
                r.pc && r.remoteSdp
                  ? (d.debug("Adding remote candidate:", t),
                    t && !0 !== t.completed
                      ? r.pc.addIceCandidate(new RTCIceCandidate(t))
            ...
            case "webrtcup":
              ...
              break;
            case "hangup":
              if ((d.debug("Got a hangup event"), d.debug(e), !G()))
                return void d.debug("This handle is not attached");
              (g.webrtcState(!1, e.reason), g.hangup());
              break;
            case "media":
              if ((d.debug("Got a media event"), d.debug(e), !G()))
                return void d.debug("This handle is not attached");
              g.mediaState(e.type, e.receiving);
              break;
            case "slowlink":
              if ((d.debug("Got a slowlink event"), d.debug(e), !G()))
                return void d.debug("This handle is not attached");
              g.slowLink(e.uplink, e.nacks);
              break;
            case "error":
              (d.error("AfricasTalking Client Error: " + e.error.code + " " + e.error.reason),
                d.debug(e));
              break;
            case "event":
              if ((d.log("Got an event"), d.log(e), void 0 === e.eventdata || null === e.eventdata))
                return void d.warn("Missing eventdata...");
              if ((d.log(e.eventdata), !G())) return void d.warn("This handle is not attachedddd");
              (void 0 !== e.jsep &&
                null !== e.jsep &&
                (d.log("Handling SDP as well..."), d.log(e.jsep)),
                null !== g.onmessage && void 0 !== g.onmessage
                  ? (d.log("Notifying application..."), g.onmessage(e.eventdata, e.jsep))
                  : d.debug("No provided notification callback"));
              break;
            default:
        ...
        T = function (e) {
          if (!h)
            return (
              ...
              void e.error("Is the gateway down? (connected=false)")
            );
          if (!G() && !U()) return (d.warn("Invalid handle"), void e.error("Invalid handle"));
          var t = e.message,
            r = e.jsep,
        ...
        b = function (e) {
          ...
          var t = g.webrtcConfig,
            r = e.text;
          if (null == r) return (d.warn("Invalid text"), void e.error("Invalid text"));
          (d.log("Sending string on data channel: " + r), t.dataChannel.send(r), e.success());
        },
        k = function (e) {
          var t = e.jsep;
          ...
          if (void 0 === n.pc || null === n.pc)
            ...
            if (
              ...
              e.stream !== n.myStream && d.log("Renegotiation involves a new external stream");
            else {
              if (r.addAudio) {
                if (
                  ((r.replaceAudio = !1),
                  (r.removeAudio = !1),
                  (r.audioSend = !0),
                  n.myStream && n.myStream.getAudioTracks() && n.myStream.getAudioTracks().length)
                )
                  return (
                    d.error(
                ...
                r.removeAudio
                  ? ((r.replaceAudio = !1), (r.addAudio = !1), (r.audioSend = !1))
                  : r.replaceAudio && ((r.addAudio = !1), (r.removeAudio = !1), (r.audioSend = !0));
              null === n.myStream || void 0 === n.myStream
                ? (r.replaceAudio && ((r.replaceAudio = !1), (r.addAudio = !0), (r.audioSend = !0)),
                  L(r) && (r.addAudio = !0))
                : (null !== n.myStream.getAudioTracks() &&
                    void 0 !== n.myStream.getAudioTracks() &&
                    0 !== n.myStream.getAudioTracks().length) ||
                  (r.replaceAudio && ((r.replaceAudio = !1), (r.addAudio = !0), (r.audioSend = !0)),
                  L(r) && (r.addAudio = !0));
            }
          if (r.update && !n.streamExternal && (r.removeAudio || r.replaceAudio)) {
            if (n.myStream && n.myStream.getAudioTracks() && n.myStream.getAudioTracks().length) {
              var i = n.myStream.getAudioTracks()[0];
              (d.log("Removing audio track:", i), n.myStream.removeTrack(i));
              try {
                i.stop();
              } catch (e) {
            ...
            if (
              ...
              for (var a in n.pc.getSenders()) {
                ...
                o &&
                  o.track &&
                  "audio" === o.track.kind &&
                  (d.log("Removing audio sender:", o), n.pc.removeTrack(o));
              }
          }
          if (null !== e.stream && void 0 !== e.stream) {
            ...
            if (
              ...
              d.debug(s),
              r.update && n.myStream && n.myStream !== e.stream && !n.streamExternal)
            ) {
              try {
          ...
          if ((d.log("Executing isAudioSendEnabled"), L(r))) {
            g.consentDialog(!0);
            var m = L(r);
            (!0 === m && null != r && null != r && "object" === p(r.audio) && (m = r.audio),
                ...
                navigator.mediaDevices
                  ...
                  .then(function (n) {
                    ...
                    if ((a || o) && !(!!a && i) && o)
                      return (
                        g.consentDialog(!1),
                        e.error("Audio capture is required, but no capture device found"),
                        !1
                      );
                    ...
                    (d.debug("getUserMedia constraints", s),
                      navigator.mediaDevices
                        .getUserMedia(s)
                        .then(function (n) {
                          (g.consentDialog(!1), D(t, r, e, n));
                        })
                        .catch(function (t) {
                          (g.consentDialog(!1),
                            e.error({ code: t.code, name: t.name, message: t.message }));
                        }));
                  })
                  .catch(function (t) {
                    (g.consentDialog(!1), e.error("enumerateDevices error", t));
                  }));
          } else D(t, r, e);
        },
        w = function (e) {
                ...
                if (
                  ...
                  for (var e in r.candidates) {
                    ...
                    (d.debug("Adding remote candidate:", n),
                      n && !0 !== n.completed
                        ? r.pc.addIceCandidate(new RTCIceCandidate(n))
                        : r.pc.addIceCandidate());
                  }
                  r.candidates = [];
                }
            ...
            : e.pc.getStats
              ? null === e.bitrate.timer || void 0 === e.bitrate.timer
                ? (d.log("Starting bitrate timer (via getStats)"),
                    ...
                    e.pc.getStats().then(function (t) {
                      t.forEach(function (t) {
                        if (t) {
                          ...
                          if (
                            (("video" === t.mediaType ||
                              t.id.toLowerCase().indexOf("video") > -1) &&
                            "inbound-rtp" === t.type &&
                            t.id.indexOf("rtcp") < 0
                              ? (r = !0)
                              : "ssrc" != t.type ||
                                !t.bytesReceived ||
                                ("VP8" !== t.googCodecName && "" !== t.googCodecName) ||
                                (r = !0),
                            r)
                          )
                            if (
                              ((e.bitrate.bsnow = t.bytesReceived),
                              (e.bitrate.tsnow = t.timestamp),
                              null === e.bitrate.bsbefore || null === e.bitrate.tsbefore)
                            )
                              ((e.bitrate.bsbefore = e.bitrate.bsnow),
                                (e.bitrate.tsbefore = e.bitrate.tsnow));
                            else {
                              var n = e.bitrate.tsnow - e.bitrate.tsbefore;
                              "safari" == l.a.browserDetails.browser && (n /= 1e3);
                              var i = Math.round((8 * (e.bitrate.bsnow - e.bitrate.bsbefore)) / n);
                              ((e.bitrate.value = i + " kbits/sec"),
                                (e.bitrate.bsbefore = e.bitrate.bsnow),
                                (e.bitrate.tsbefore = e.bitrate.tsnow));
                            }
                        }
                  ...
                  "0 kbits/sec")
                : e.bitrate.value
              : (d.warn("Getting the video bitrate unsupported by browser"),
        ...
        P = function (e) {
          ...
          if (null === t.dtmfSender || void 0 === t.dtmfSender) {
            if (void 0 !== t.pc && null !== t.pc) {
              ...
              if (!r)
                return (
                  d.warn("Invalid DTMF configuration (no audio track)"),
                  void e.error("Invalid DTMF configuration (no audio track)")
                );
              ((t.dtmfSender = r.dtmf),
                t.dtmfSender &&
          ...
          var n = e.dtmf;
          if (null == n)
            return (d.warn("Invalid DTMF parameters"), void e.error("Invalid DTMF parameters"));
          var i = n.tones;
          if (null == i)
            return (d.warn("Invalid DTMF string"), void e.error("Invalid DTMF string"));
          var a = n.duration;
          null == a && (a = 500);
          var o = n.gap;
          (null == o && (o = 50),
            d.debug("Sending DTMF string " + i + " (duration " + a + "ms, gap " + o + "ms)"),
          ...
          if ((d.log("Cleaning WebRTC stuff"), G())) {
            ...
            if (null != t) {
              if (!0 === e) {
                ...
                (d.debug("Sending hangup request"), d.debug(r), f.send(JSON.stringify(r)));
              }
              ((t.remoteStream = null),
                t.volume.timer && clearInterval(t.volume.timer),
                (t.volume.value = null),
                t.bitrate.timer && clearInterval(t.bitrate.timer),
              ...
              try {
                if (!t.streamExternal && null !== t.myStream && void 0 !== t.myStream) {
        ...
        D = function (e, t, r, n) {
          if (!G() && !U()) return (d.warn("Invalid handle"), void r.error("Invalid handle"));
          ...
          if (i.myStream && t.update && !i.streamExternal) {
            if (
              ((!t.update && L(t)) || (t.update && (t.addAudio || t.replaceAudio))) &&
              n.getAudioTracks() &&
              n.getAudioTracks().length
            )
              if (
                (i.myStream.addTrack(n.getAudioTracks()[0]),
                t.replaceAudio && "firefox" === l.a.browserDetails.browser)
              )
                for (var o in (d.log("Adding audio track:", n.getAudioTracks()[0]),
                i.pc.getSenders())) {
                  var s = i.pc.getSenders()[o];
                  s && s.track && "audio" === s.track.kind && s.replaceTrack(n.getAudioTracks()[0]);
                }
              else
                (d.log(
                  (t.replaceAudio ? "Replacing" : "Adding") + " audio track:",
                  n.getAudioTracks()[0]
                ),
          ...
          if (!i.pc) {
            ...
            if (r.rtcConstraints && "object" === p(r.rtcConstraints))
              for (var f in (d.debug("Adding custom PeerConnection constraints:", r.rtcConstraints),
              r.rtcConstraints))
                u.optional.push(r.rtcConstraints[f]);
            ("edge" === l.a.browserDetails.browser && (c.bundlePolicy = "max-bundle"),
              d.log("Creating PeerConnection"),
              d.debug(u),
              d.log(
                "new RTCPeerConnection" +
                  JSON.stringify({ iceServers: c.iceServers, pc_constraints: u })
              ),
              (i.pc = new RTCPeerConnection(c, u)),
              d.log("This is the peer connection created " + JSON.stringify(i.pc)),
              i.pc.getStats && ((i.volume.value = 0), (i.bitrate.value = "0 kbits/sec")),
              d.log("Preparing local SDP and gathering candidates (trickle=" + i.trickle + ")"),
                  ...
                  (d.log("End of candidates."),
                    ...
                    !0 === i.trickle
                      ...
                      : (function (e) {
                          if (G() || U()) {
                            var t = g.webrtcConfig;
                            (d.log("Sending offer/answer SDP..."),
                              null !== t.mySdp && void 0 !== t.mySdp
                                ? ((t.mySdp = {
                                    type: t.pc.localDescription.type,
                                    sdp: t.pc.localDescription.sdp,
                                  }),
                                  !1 === t.trickle && (t.mySdp.trickle = !1),
                                  d.debug(e),
                                  (t.sdpSent = !0),
                                  e.success(t.mySdp))
                                : d.warn("Local SDP instance is invalid, not sending anything..."));
              ...
              (i.pc.ontrack = function (e) {
                (d.log("Handling Remote Track"),
                  ...
                  e.streams &&
                    ...
                    e.track &&
                      !e.track.onended &&
                      (d.log("Adding onended callback to track:", e.track),
                      (e.track.onended = function (e) {
                        (d.log("Remote track removed:", e),
                          i.remoteStream &&
                            (i.remoteStream.removeTrack(e.target),
                            g.onremotestream(i.remoteStream)));
                      }))));
              }));
          }
          (a &&
            ...
            null == e
              ? (function (e, t) {
                  if (!G() && !U())
                    return (d.warn("Invalid handle"), void t.error("Invalid handle"));
                  var r = g.webrtcConfig,
                    n = !0 === t.simulcast;
                  n
                    ? d.log("Creating offer (iceDone=" + r.iceDone + ", simulcast=" + n + ")")
                    : d.log("Creating offer (iceDone=" + r.iceDone + ")");
                    ...
                    r.pc.createOffer(
                      function (e) {
                        if (
                          ...
                          (d.log("Offer ready"), d.debug(t));
                          var n = { type: e.type, sdp: e.sdp };
                          t.success(n);
                  ...
                  function () {
                    if (
                      ...
                      for (var n in i.candidates) {
                        ...
                        (d.debug("Adding remote candidate:", a),
                          a && !0 !== a.completed
                            ? i.pc.addIceCandidate(new RTCIceCandidate(a))
                    ...
                    !(function (e, t) {
                      ...
                      var r = g.webrtcConfig,
                        n = !0 === t.simulcast;
                      n
                        ? d.log("Creating answer (iceDone=" + r.iceDone + ", simulcast=" + n + ")")
                        : d.log("Creating answer (iceDone=" + r.iceDone + ")");
                      var i = null;
                      ((i =
                        "firefox" == l.a.browserDetails.browser ||
                        "edge" == l.a.browserDetails.browser
                          ? { offerToReceiveAudio: j(e) }
                          : { mandatory: { OfferToReceiveAudio: j(e) } }),
                        d.debug(i),
                        r.pc.createAnswer(
                          function (e) {
                            if (
        ...
        x = function (e, t) {
          if (h) {
            ...
            (d.vdebug("Sending trickle candidate"), d.vdebug(r), f.send(JSON.stringify(r)));
        ...
        O = function () {
          if (!G() && !U()) return (d.warn("Invalid handle"), !1);
          var e = g.webrtcConfig;
          return e.pc.getStats && "chrome" == l.a.browserDetails.browser
            ? null === e.remoteStream || void 0 === e.remoteStream
              ? (d.warn("Remote stream unavailable"), 0)
              : null === e.volume.timer || void 0 === e.volume.timer
                ? (d.log("Starting volume monitor"),
                  (e.volume.timer = setInterval(function () {
                    e.pc.getStats(function (t) {
                      for (var r = t.result(), n = 0; n < r.length; n++) {
                        var i = r[n];
                        "ssrc" == i.type &&
                          i.stat("audioOutputLevel") &&
                          (e.volume.value = i.stat("audioOutputLevel"));
                      }
                    });
                  }, 200)),
                  0)
                : e.volume.value
            : (d.log("Getting the remote volume unsupported by browser"), 0);
        },
        I = function () {
          var e = function () {
        ...
        L = function (e) {
          return (
            ...
            null == e ||
              (!1 !== e.audio &&
                (void 0 === e.audioSend || null === e.audioSend || !0 === e.audioSend))
          );
        },
        A = function (e) {
          return (
        ...
        j = function (e) {
          return (
            ...
            null == e ||
              (!1 !== e.audio &&
                (void 0 === e.audioRecv || null === e.audioRecv || !0 === e.audioRecv))
          );
        },
        N = function e() {
          if (h) {
                    ...
                    case 0:
                      return e.abrupt(
                        ...
                        new Promise(function (e, n) {
                          ((J.server = new WebSocket(t.server, ["at-protocol", t.capabilityToken])),
                            (J.server.onopen = function () {
                              var t, n;
                              (d.log("Sending initial request to Africa's Talking APIs "),
                                (t = r),
                                (n = J.server),
                                (f = n),
                                (m = t.emitEvent),
                                ...
                                (y = function () {
                                  ...
                                  var e = {
                                    ...
                                    consentDialog: t.consentDialog,
                                    iceState: t.iceState,
                                    mediaState: t.mediaState,
                                    webrtcState: t.webrtcState,
                                    slowLink: t.slowLink,
                                    onmessage: t.onmessage,
                                    onlocalstream: t.onlocalstream,
                                    onremotestream: t.onremotestream,
                                    ondata: t.ondata,
                                    ondataopen: t.ondataopen,
                                  ...
                                  window.addEventListener(r ? "pagehide" : "unload", function () {
                                    f.close();
                                  });
                                }),
                                e(J.server));
                            }),
                            (J.server.onmessage = function (t) {
                              (d.log("Got this message from the websocket: " + t.data),
                                C(JSON.parse(t.data)),
                                e(J.server));
                            }),
                            (J.server.onclose = function (t) {
                              (d.log(
                                "Lost connection to the gateway (is it down?)" + JSON.stringify(t)
                              ),
                                I(),
                                e(J.server));
                            }),
                            (J.server.onerror = function (e) {
                              (d.error(
      ...
      var V = z,
        ...
        W = function (e) {
          ...
          var i,
            ...
            o = !1;
          ((i = function () {
            ((B = { audio: a, audioCap: o }), d.log({ supportedDevices: B }), e());
          }),
            d.log({
                  ...
                  ? ((t = []),
                    navigator.enumerateDevices(function (e) {
                      (e.forEach(function (e) {
                        ...
                        ("audio" === i.kind && (i.kind = "audioinput"),
                          t.forEach(function (e) {
                            e.id === i.id && e.kind === i.kind && (n = !0);
                          }),
                          n ||
                            (i.deviceId || (i.deviceId = i.id),
                            i.id || (i.id = i.deviceId),
                            i.label
                              ? "audioinput" !== i.kind || o || (o = !0)
                              : ((i.label = "Please invoke getUserMedia once."),
                                r ||
                                  (i.label =
                                    "HTTPs is required to get label of this " +
                                    i.kind +
                                    " device.")),
                            "audioinput" === i.kind && (a = !0),
                            t.push(i)));
                      }),
                        i && i());
                    }))
        ...
        ne = (function () {
          function e(t) {
            ...
            ((this.token = t),
              ...
              Array.isArray(i) && i.length > 0 && (this.iceServers = de(i)));
            var s = ce(o);
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  W(function () {
                    Y.createOffer({
                      iceServers: t,
                      media: { audioSend: !0, audioRecv: !0 },
                      success: function (t) {
                        (d.debug("Got SDP!"), d.debug(t), d.log({ to: e, jsep: t }));
                        var r = { request: "call", to: e };
                        (Y.send({ message: r, jsep: t }), (Q = e));
                      },
                      error: function (e) {
                        d.error("AfricasTalking Client Error: ", e);
                      },
                    });
                  });
                },
                  ...
                  (($ = null),
                    W(function () {
                      Y.createAnswer({
                        ...
                        media: { audio: !0 },
                        success: function (e) {
                          (d.debug("Got SDP! audio=true, video=" + !0),
                            d.debug(e),
                            Y.send({ message: { request: "accept" }, jsep: e }));
                        },
                        error: function (e) {
                          (d.error("AfricasTalking Client Error: ", e),
                            Y.send({ message: { request: "decline", code: 480 } }));
                        },
                      });
                    }));
                },
      ...
      function ie() {
        ...
        Y
          ...
          : !0 !== this.initDone &&
            ...
            e ||
              (((e = document.createElement("audio")).id = "remote-stream-audio"),
              (e.autoplay = !0),
            ...
            V.isWebrtcSupported()
              ? new V({
                  ...
                  onmessage: function (e, t) {
                    (d.log(" ::: Got a message :::"), d.log(JSON.stringify(e)));
                    var r = e.error;
                    if (null == r || null == r) {
                      var n = e.result;
                      if (
                        (d.log("This is the result " + n.toString),
                        null != n && void 0 !== n.event && null !== n.event)
                      ) {
                        var i = n.event;
                        switch (i) {
                          case "registration_failed":
                            return (
                              d.log("Registration failed: " + n.code + " " + n.reason),
                              void ae()
                            );
                          case "registered":
                            (d.log("Successfully registered as " + n.username + "!"),
                              re || ((re = !0), te.emit("ready")));
                            break;
                          case "unregistered":
                            (d.log("Successfully unregistered as " + n.username + "!"),
                              re && ((re = !1), te.emit("notready")));
                            break;
                          case "calling":
                            (d.log("Waiting for the peer to answer..."), te.emit("calling"));
                            break;
                          case "incomingcall":
                            ((Q = e.result.username.split("@")[0].split(":")[1]),
                              ($ = !0),
                              Z.play(),
                              d.log("Incoming call from " + n.username + "!"),
                              (X = t),
                              te.emit("incomingcall", { from: Q }));
                            break;
                          case "progress":
                            (d.log(
                              "There's early media from " + n.username + ", wairing for the call!"
                            ),
                              null != t && se(t));
                            break;
                          case "missed_call":
                            ((Q = e.result.caller.split("@")[0].split(":")[1]),
                              d.log("Missed call from " + n.caller + "!"),
                              te.emit("missedcall", { from: Q }));
                            break;
                          case "accepted":
                            (ee.pause(),
                              Z.pause(),
                              d.log(n.username + " accepted the call!"),
                              null != t && se(t),
                          ...
                          case "hangup":
                            (($ = null),
                              ee.pause(),
                              Z.pause(),
                              d.log("Call hung up (" + n.code + " " + n.reason + ")!"),
                              Y.hangup(),
                              te.emit("hangup", { code: n.code, reason: n.reason }));
                            break;
                          case "decline":
                            (($ = null),
                              ee.pause(),
                            ...
                            break;
                          default:
                            d.log("Received random json request " + i.toString);
                        }
                      }
                    } else
                      re
                        ? (ee.pause(), Z.pause(), Y.hangup())
                        : d.log("User is not registered" + r);
                  },
                  emitEvent: function (e) {
                    te.emit(e);
                  },
                  onlocalstream: function (e) {
                    (d.log(" ::: Got a local stream :::"), d.log(JSON.stringify(e)));
                  },
                  onremotestream: function (t) {
                    (d.debug(" ::: Got a remote stream :::"), d.debug(JSON.stringify(t)));
      ...
      var ae = function () {
        ...
        de = function (e) {
          ...
          return (
            e.forEach(function (e) {
              if ("string" == typeof e.urls && e.urls.startsWith("stun:")) t.push({ urls: e.urls });
              else if (
                "string" == typeof e.urls &&
                (e.urls.startsWith("turn:") || e.urls.startsWith("turns:"))
              )
                t.push({ urls: e.urls, username: e.username, credential: e.credential });
              else if (Array.isArray(e.urls)) {
                var r = e.urls.filter(function (e) {
                  return "string" == typeof e && (e.startsWith("turn:") || e.startsWith("turns:"));
                });
                r.length === e.urls.length
                  ? t.push({ urls: r, username: e.username, credential: e.credential })
                  : d.error(
                ...
                d.error(
                  "AfricasTalking Client Error: Invalid iceServer param ".concat(JSON.stringify(e))
                );
            }),
            t
          );
...
//# sourceMappingURL=africastalking.js.map
